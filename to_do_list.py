...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.button_delete_task.clicked.connect(self.delete_selected_field)
        self.button_delete_category.clicked.connect(self.delete_selected_field)
        # print((self.button_delete_task.clicked.connect.__doc__))
